...
- Targeting $k$ via acceptance rates [(Drovandi et al, 2011)](https://doi.org/10.1016/j.csda.2011.03.019)
- Target ting median ESJD across particles [(Salomone et al, 2018)](https://arxiv.org/abs/1805.03924)
...
- Framework for tuning mutation kernels in SMC


--

- Surrogate likelihoods used in SMC
...
- Working on Whittle likelihood time series application
